...
### El intervalo de confianza para el $\beta_0$ es entre [-105.96600, -73.176113]
### El intervalo de confianza para el $\beta_1$ es entre [3.21458,   3.730327]
...
### El intervalo de confianza para el $\beta_0$ es entre [-112.531681, -39.704357]
### El intervalo de confianza para el $\beta_1$ es entre [ 2.707321,   3.832888]
...
jns.boot.obser=function(datos,B,Y){
...
index_salida <- 2 # 
nro_muestras_bootstrap <- 150
bootstrap_datos <- jns.boot.obser(women,nro_muestras_bootstrap,index_salida)
